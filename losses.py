...
class SAMLoss(nn.Module):
    ...
    def forward(self, inputs, targets, iou_pred, ignored_masks=None):
        ...
        # FIX: clamp targets to valid class index range before one_hot encoding.
        # Without this, any pixel with label >= num_classes (e.g. 255 padding)
        # causes F.one_hot's scatter to throw a CUDA index-out-of-bounds assert.
        targets = targets.clamp(0, inputs.shape[1] - 1)       # ← ONE LINE FIX
